...
<template>
    ...
    <div
        class="
          flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6
          text-[#1b1b18]
    ...
    >
        <header
            class="
              mb-6 w-full max-w-[335px] text-sm
              not-has-[nav]:hidden
              lg:max-w-4xl
            "
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboardUrl"
                    class="
                      inline-block rounded-sm border border-[#19140035] px-5
                      py-1.5 text-sm/normal text-[#1b1b18]
                      hover:border-[#1915014a]
                      dark:border-[#3E3E3A] dark:text-[#EDEDEC]
                ...
                <template v-else>
                    <Link
                        :href="login()"
                        class="
                          inline-block rounded-sm border border-transparent px-5
                          py-1.5 text-sm/normal text-[#1b1b18]
        ...
        <div
            class="
              flex w-full items-center justify-center opacity-100
        ...
        >
            <main
                class="
                  flex w-full max-w-[335px] flex-col-reverse overflow-hidden
                  rounded-lg
            ...
            >
                <div
                    class="
                      flex-1 rounded-b-lg bg-white p-6 pb-12 text-[13px]
                      leading-[20px]
                ...
                >
                    ...
                    >
                        <li
                            class="
                              ...
                              before:absolute before:top-1/2 before:bottom-0
                              before:left-[0.4rem] before:border-l
                        ...
                        >
                            ...
                            >
                                <span
                                    class="
                                      ...
                                      rounded-full border border-[#e3e3e0]
                                      bg-[#FDFDFC]
                                ...
                                >
                                    <span
                                        class="
                                          size-1.5 rounded-full bg-[#dbdbd7]
                                          dark:bg-[#3E3E3A]
                                        "
                                    />
                                </span>
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="
                                      ml-1 inline-flex items-center space-x-1
                                      font-medium text-[#f53003] underline
                                      underline-offset-4
                                      dark:text-[#FF4433]
                                    "
                                >
                    ...
                    <ul class="flex gap-3 text-sm/normal">
                        <li>
                            <a
                                href="https://cloud.laravel.com"
                                target="_blank"
                                class="
                                  inline-block rounded-sm border border-black
                                  bg-[#1b1b18] px-5 py-1.5 text-sm/normal
                                  text-white
                                  hover:border-black hover:bg-black
                                  dark:border-[#eeeeec] dark:bg-[#eeeeec]
                                  dark:text-[#1C1C1A]
                ...
                <div
                    class="
                      relative -mb-px aspect-335/364 w-full shrink-0
                      overflow-hidden rounded-t-lg bg-[#fff2f2]
                      lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px]
                ...
                >
                    ...
                    <svg
                        class="
                          w-full max-w-none translate-y-0 text-[#F53003]
                          opacity-100 transition-all duration-750
                          dark:text-[#F61500]
                          starting:opacity-0
                    ...
                    <svg
                        class="
                          relative mt-[-6.6rem] -ml-8 w-[438px] max-w-none
                          [--stroke-color:#1B1B18]
                          lg:ml-0
                    ...
                    >
                        <g
                            class="
                              text-[#1B1B18] opacity-100 mix-blend-darken
                              transition-all delay-300 duration-750
                              dark:text-black dark:mix-blend-normal
                              starting:opacity-0
                            "
                        >
                            <mask
                        ...
                        <g
                            class="
                              text-[#F3BEC7] opacity-100 transition-all
                              delay-400 duration-750
                              dark:text-[#4B0600]
                              starting:opacity-0
                        ...
                        <g
                            class="
                              text-[#F8B803] opacity-100 mix-blend-color
                              transition-all delay-400 duration-750
                              dark:text-[#391800] dark:mix-blend-hard-light
                              starting:opacity-0
                        ...
                        <g
                            class="
                              text-[#F3BEC7] opacity-100 mix-blend-multiply
                              transition-all delay-400 duration-750
                              dark:text-[#733000] dark:mix-blend-normal
                              starting:opacity-0
                        ...
                        <g
                            class="
                              text-[#F3BEC7] opacity-100 mix-blend-hard-light
                              transition-all delay-400 duration-750
                              dark:text-[#4B0600]
                              starting:opacity-0
